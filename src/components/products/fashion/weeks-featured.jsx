            ...
            <SwiperSlide key={item._id} className="tp-featured-item white-bg p-relative z-index-1">
              ...
              <div className="tp-featured-content">
                <h3 className="tp-featured-title">
                  <a onClick={() => dispatch(handleProductModal(item))} style={{ cursor: 'pointer' }}>{title}</a>
                </h3>
                ...
                <div className="tp-featured-btn">
                  <a onClick={() => dispatch(handleProductModal(item))} className="tp-btn tp-btn-border tp-btn-border-sm" style={{ cursor: 'pointer' }}>Shop Now
                    {" "}<ArrowRightLong />
                  </a>
                </div>
              </div>
